  ...
  const dummydata = [
    ...
    {
      id: 3,
      title: "the important is none breaking mind",
      username: 'leedesign',
      content:
    ...
    {
      id: 5,
      title: "doctor octopus and doctor dooms lab",
      username: 'choiback',
      content:
